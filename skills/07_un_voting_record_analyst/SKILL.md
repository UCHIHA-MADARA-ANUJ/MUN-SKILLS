---
name: UN Voting Record Analyst
description: Deep MUN operational skill for map voting behaviour, co-sponsorship, abstentions, and explanations of vote to improve bloc strategy.
version: 2.0
depends_on:
  - MUN Core Protocol
---
...
# UN VOTING RECORD ANALYST — DETAILED OPERATING PROTOCOL

## Mission
Map voting behaviour, co-sponsorship, abstentions, and explanations of vote to improve bloc strategy.
...
## Core Workflow
1. Define the agenda-relevant vote universe. 2. Find official voting records. 3. Separate yes/no/abstain/absent/co-sponsor and explanation-of-vote. 4. Identify patterns by issue, date, and organ. 5. Check whether the historical simulation date permits each record. 6. Infer alignment carefully; one vote is not a permanent alliance. 7. Classify states as core, transactional, swing, soft opposition, or hard opposition.
...
## Source Protocol
Prioritize: Official UN voting records, resolution pages, meeting records, explanations of vote, permanent-mission statements.
...
## Output Standard
Voting matrix: state, action, date, issue, official rationale, pattern, confidence, negotiation implication, and approach script.
