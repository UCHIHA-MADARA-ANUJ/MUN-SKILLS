...
description: Deep MUN operational skill for locate the highest-authority original evidence for every material mun claim.
version: 2.0
depends_on:
  - MUN Core Protocol
---
...
# PRIMARY SOURCE HUNTER — DETAILED OPERATING PROTOCOL

## Mission
Locate the highest-authority original evidence for every material MUN claim.
...
## Core Workflow
1. Atomize the claim. 2. Classify it as position, law, resolution, vote, statistic, implementation report, or current event. 3. Select the institution most authoritative for that class. 4. Search primary sources first. 5. Open the actual document, not only a search snippet. 6. Confirm publisher, title, date, scope, and supporting passage or section. 7. Cross-check consequential claims. 8. Create an evidence card and a safe speaking line.
...
## Source Protocol
Prioritize: UN documents and official pages; government ministries and permanent missions; treaty texts and vote records; official UN agencies and international organisations; reputable reporting only when primary evidence is unavailable or delayed.
...
## Output Standard
Claim; status label; source title and direct link; institution; publication date; supporting section/page; scope; committee use; limitation; safe speaking line.
