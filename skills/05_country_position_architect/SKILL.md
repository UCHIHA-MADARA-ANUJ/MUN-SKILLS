---
name: Country Position Architect
description: Deep MUN operational skill for build a defensible delegate doctrine rooted in the assigned country’s real interests, public record, constraints, and negotiating space.
version: 2.0
depends_on:
  - MUN Core Protocol
---
...
# COUNTRY POSITION ARCHITECT — DETAILED OPERATING PROTOCOL

## Mission
Build a defensible delegate doctrine rooted in the assigned country’s real interests, public record, constraints, and negotiating space.
...
## Core Workflow
1. Establish the country’s public agenda position through official statements and votes. 2. Map interests: security, economy, sovereignty, development, law, region, capacity, and domestic constraints. 3. Identify allies, dependencies, treaty commitments, and vulnerabilities. 4. Separate red lines, conditional support, and tradeable language. 5. Design three to five country-authentic proposals. 6. Predict attacks and draft evidence-led responses. 7. Test every recommendation against historical date and committee mandate.
...
## Source Protocol
Prioritize: Foreign ministry and permanent-mission statements; official UN speeches and votes; government policy documents; treaty memberships; official data; reputable context sources.
...
## Output Standard
One-sentence doctrine; public position; interests; red lines; negotiation space; bloc map; leadable solutions; vulnerabilities; responses; speech and negotiation lines.
